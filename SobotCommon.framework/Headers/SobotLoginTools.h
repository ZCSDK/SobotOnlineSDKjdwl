...
///   - version: 版本
///   - resultBlock: 登录结果
-(void)doAppSDKLogin:(NSString *)email token:(nonnull NSString *)token status:(int)loginStatus appVersin:(NSString *)version result:(void (^)(NSInteger code, NSDictionary * _Nullable, NSString * _Nullable))resultBlock;
